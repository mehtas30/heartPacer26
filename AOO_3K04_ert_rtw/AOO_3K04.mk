###########################################################################
## Makefile generated for component 'AOO_3K04'. 
## 
## Makefile     : AOO_3K04.mk
## Generated on : Mon Oct 17 16:59:58 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AOO_3K04.elf
...
COMPILER_COMMAND_FILE     = AOO_3K04_comp.rsp
CMD_FILE                  = AOO_3K04.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AOO_3K04.elf
...
DEFINES_STANDARD = -DMODEL=AOO_3K04 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/AOO_3K04_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AOO_3K04_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AOO_3K04_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AOO_3K04_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AOO_3K04_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AOO_3K04_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AOO_3K04.o : $(START_DIR)/AOO_3K04_ert_rtw/AOO_3K04.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AOO_3K04_data.o : $(START_DIR)/AOO_3K04_ert_rtw/AOO_3K04_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
